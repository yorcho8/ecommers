...
export async function DELETE({ params, cookies }) {
  try {
    ...
    // Soft delete — cambia estado a 'eliminado' (las imágenes en BD se limpian por CASCADE si prefieres hard delete)
    await db.execute({
